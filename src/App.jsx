      ...
      <div className="main w-full rotate-[-10deg] scale-[1.7] ">
        <div className="landing overflow-hidden relative w-full h-screen bg-black">
          ...
          <div className="btmbar text-white absolute bottom-0 left-0 w-full py-15 px-10 bg-gradient-to-t from-black to-transparent">
            ...
            <img className="absolute h-[55px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" src="./ps5.png" />
          </div>
        </div>
        ...
        {/* Footer */}
        <footer className="w-full py-6 bg-black text-white text-center text-sm  font-[Helvetica_Now_Display]">
          All Rights Reserved © Muhammad Arsalan Aftab
        </footer>
      </div>
    )}
    </>
